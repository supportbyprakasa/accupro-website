...
export const ic = (n, s = 20, cls = '') =>
  `<svg${cls?` class="${cls}"`:''} width="${s}" height="${s}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${P[n]||''}</svg>`;
export const logoMark = (cls='brand__mark') => `<svg class="${cls}" viewBox="0 0 34 32" fill="none" aria-hidden="true">
